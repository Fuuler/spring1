...
import ru.gb.service.CartServiceImpl;
...
public class RunApp {
    ...
    public RunApp(ProductService productService, CartServiceImpl cartService) {
                ...
                if (command.equalsIgnoreCase("exit")) {
                    ...
                    if (command.equalsIgnoreCase("add")) {
                        ...
                        if (cartService.getProductQuantity(cart, prodId) > 0) {
                            cartService.deleteProduct(cart, productService.getProductById(prodId), quantity);
    ...
    private static void listCommand() {
        ...
        System.out.println("Удалить продукт: delete [N продукта] [количество]");
    ...
    private void cartTest() {
        ...
        cartService.deleteProduct(cart, productService.getProductById(2L), 1);
        // удалить продукт из корзины
        cartService.deleteProduct(cart, productService.getProductById(4L), 999);
        cartService.deleteProduct(cart, productService.getProductById(5L), null);
